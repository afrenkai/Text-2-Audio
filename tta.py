...
torchaudio.set_audio_backend("soundfile")  # can do other ones as well, or replace w librosa later since taudio dookie
...
class AudioDecoder(nn.Module):
    ...
    def __init__(self, input_dim: int = 256, hidden_dim: int = 256, mel_dim: int = 80, num_heads: int = 8,
                 num_layers: int = 3):
